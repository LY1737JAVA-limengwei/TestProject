...
<body>
    ...
    <ul class="placeul">
    <li><a href="#">首页</a></li>
    <li><a href="#">添加教师账号</a></li>
    </ul>
    </div>
    
    <div class="formbody">
    
	    <div class="formtitle"><span>输入账号信息</span></div>
	    <form action="user?oper=adduser" method="post" id="tj" target="_top">
		    <ul class="forminfo">
			    <li><label>用户名</label><input name="addusername" type="text" class="dfinput" /><i></i></li>
			    <li><label>密码</label><input name="adduserpwd" type="text" class="dfinput" /><i></i></li>
