...
<div class="place">
	...
	<div class="formbody">
	  <div class="formtitle"><span>修改密码信息</span></div>
		...
		<input type="hidden" name="oper" value="modifyuserpwd" />
			<ul class="forminfo">
				<li><label>用户名</label><input name="modifyuser" value="${User.uname }" id="newPwd" type="text" class="dfinput" /></li>
				<li><label>密码</label><input name="modifypwd" value="${User.pwd }" id="cfPwd" type="text" class="dfinput" /></li>
