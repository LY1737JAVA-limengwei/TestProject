...
<body class="sarchbody">
    ...
    <form action="notice" method="post">
    	<input type="hidden" name="oper" value="searchNoticeadmin" /> 
	    <ul class="prosearch">
		    <li>
		    	<label>查询：</label>
		    	<i>通知标题</i><a><input name="nitile" type="text" class="scinput" /></a>
    	...
    	<tbody>
        	...
        	%>
				        <tr>
					        ...
					        <td>
					        	<a href="notice?oper=showmodifyNotice&id=<%=noi.getId() %>" class="tablelink" onclick="">修改</a>
					        	<label>&nbsp;</label>
					        	<a href="notice?oper=deleteNotice&id=<%=noi.getId() %>" class="tablelink" onclick="">删除</a>
					        </td>
				        </tr> 
				  <%} %>
        </tbody>
