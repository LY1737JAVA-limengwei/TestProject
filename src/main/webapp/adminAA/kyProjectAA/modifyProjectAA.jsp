...
<body>
    ...
    <div class="formbody">
	    ...
	    <input type="hidden" name="pid" value="${KyProject.pid }" /> 
		    <ul class="forminfo">
			    <li><label>项目标题</label><input name="ptitle" type="text" class="dfinput" value="${KyProject.ptitle }" /><i></i></li>
			    <li><label>项目类型</label><input name="ptype" type="text" class="dfinput"  value="${KyProject.ptype }" /><i></i></li>
